...
test("It should send tiny plain text file to provided IPv4 loopback", "test/test1.txt", "127.0.0.1")
...
test("It should send tiny plain text file to localhost hostname translated to IPv4 address", "test/test3.txt", "localhost")
test("It should send tiny plain text file to IPv6 local address", "test/test4.txt", "fc00::")
test("It should send tiny image to IPv6 loopback address", "test/test5.png", "::1")
